...
const ResultsShowcase = () => {
    const { t } = usePreferences();
    const systems = [
        { title: 'Facebook Ad Research System', blurb: 'Scrapes top-performing competitor ads via Apify, then rewrites them with OpenAI + Gemini.', tags: ['n8n', 'Apify', 'OpenAI'], github: 'https://github.com/firstlinkai/Facebook-Ad-Research-System', Icon: BarChart3, gradient: 'from-rose-500 to-orange-400' },
        { title: 'SEO Blog Engine (YouTube→Blog)', blurb: 'Turns any YouTube video into a structured, publish-ready blog post — automatically.', tags: ['AI', 'Content', 'Automation'], github: 'https://github.com/firstlinkai/youtube-to-blog', Icon: PenTool, gradient: 'from-blue-600 to-indigo-500' },
        { title: 'RAG Chatbot Agent', blurb: 'A retrieval-augmented chatbot grounded in your own documents — built on n8n, Gemini & Qdrant.', tags: ['n8n', 'Gemini', 'Qdrant'], github: 'https://github.com/firstlinkai/RAG-Agent', Icon: Zap, gradient: 'from-violet-600 to-fuchsia-500' },
        { title: 'One-Click Social Automation', blurb: 'Publish across every major platform in one click — a unified omnichannel autoposter.', tags: ['n8n', 'Social APIs'], github: 'https://github.com/firstlinkai/Social-Media-Automation', Icon: Globe, gradient: 'from-emerald-500 to-teal-400' },
        { title: 'Automated Facebook Ad Creation', blurb: 'Generates ready-to-launch Facebook ad creatives and copy from a single product input.', tags: ['AI', 'Meta Ads'], github: 'https://github.com/firstlinkai/Automated-Facebook-Ad-Creation-System', Icon: Layout, gradient: 'from-sky-500 to-blue-500' },
        { title: 'Automated CV Ranking', blurb: 'Scores and ranks inbound CVs against role criteria for an instant recruitment shortlist.', tags: ['n8n', 'AI', 'Recruitment'], github: 'https://github.com/firstlinkai/Automated-CV-Ranking', Icon: Search, gradient: 'from-amber-500 to-orange-500' },
    ];
    return (
